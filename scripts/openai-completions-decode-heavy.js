...
export default function run() {
  ...
  const messages = [
    { role: 'system', content: 'You are a helpful, thorough, and detailed assistant. When asked for information, provide comprehensive, well-structured responses.' },
  ...
  console.log(`Decode test with prompt: "${promptText.substring(0, 50)}..."`);
